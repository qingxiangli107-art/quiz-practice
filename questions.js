const QUESTIONS = [
  ...
  },
  {
    ...
    "set": 1,
    "type": "case",
    "question": "关于智能客服智能体在银行中的应用，以下说法正确的是？",
    "options": {
      "A": "该智能体能够理解用户自然语言问题并自动回复常见咨询",
      "B": "智能体可调用后台API查询用户账户余额（经授权）",
      "C": "可通过大数据分析用户历史投诉记录，优化智能体的应答策略",
      "D": "智能体完全替代所有人工客服，无需任何人工介入"
    },
    "answer": "ABC",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "set": 1,
    "type": "case",
    "question": "某金融公司使用大数据与AI智能体进行反欺诈交易监测。以下哪些描述符合实际技术应用？",
    "options": {
      "A": "实时分析交易特征（如地点、金额、设备指纹）判断异常",
      "B": "使用规则引擎+机器学习模型双重检测",
      "C": "智能体可根据新出现的欺诈模式在线更新模型（如在线学习）",
      "D": "所有交易必须人工审核后才能触发智能体报警"
    },
    "answer": "ABC",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "set": 3,
    "type": "single",
    "question": "大数据技术中，Hadoop生态系统的核心组件分布式文件系统",
    "options": {
      "A": "分布式存储",
      "B": "实时数据库查询",
      "C": "图形界面显示",
  ...
  },
  {
    ...
    "set": 3,
    "type": "single",
    "question": "在长耳朵数智优才图形化大数据平台中，统计不同月份的销售总金额的操作，下面那项是正确的",
    "options": {
      "A": "",
      "B": "",
      "C": "",
  ...
  },
  {
    ...
    "set": 3,
    "type": "single",
    "question": "下列对应的数据属性类型错误的一项是",
    "options": {
      "A": "数值型：两个鸡蛋的重量",
      "B": "序数型：衣服尺码（S,M,L,XL等）",
      "C": "类别型：水果的名称",
      "D": "随机型：销售商品、货物的品牌名"
    },
    "answer": "D",
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "数据挖掘必须使用深度学习",
      "C": "关联规则学习（如购物篮分析）属于数据挖掘方法",
      "D": "大数据为数据挖掘提供了更丰富的数据基础"
    },
    "answer": "ACD",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "set": 3,
    "type": "multiple",
    "question": "以下哪些属于“无人驾驶”中智能体的典型模块？",
    "options": {
      "A": "感知模块（识别车道、行人）",
      "B": "规划模块（路径规划）",
      "C": "控制模块（转向、加减速）",
  ...
  },
  {
    ...
    "set": 3,
    "type": "judge",
    "question": "数据可视化中的“气泡图”可以在二维平面上展示三个维度的数据",
    "options": {
      "A": "正确",
      "B": "错误"
    },
  ...
  },
  {
    ...
    "set": 3,
    "type": "judge",
    "question": "“数据分析中的描述性统计”包括均值、中位数、标准差等，但不包括数据分布形状",
    "options": {
      "A": "正确",
      "B": "错误"
    },
  ...
  },
  {
    ...
    "set": 3,
    "type": "case",
    "question": "物流公司使用AI智能体调度配送机器人。以下正确的是",
    "options": {
      "A": "每个配送机器人需要感知环境（障碍物、路径）",
      "B": "调度系统不需要处理实时订单数据，只需静态路线规划",
      "C": "多个机器人之间可能发生冲突，需要协调机制",
      "D": "这种系统完全不需要历史数据，实时规划即可"
    },
    "answer": "AC",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "options": {
      "A": "需要处理非结构化数据（如医生笔记）",
      "B": "预测模型可以使用逻辑回归或随机森林",
      "C": "数据隐私（如HIPAA）是该场景的重要约束",
      "D": "模型只需考虑当前就诊记录，无需历史记录"
    },
    "answer": "ABC",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "set": 3,
    "type": "case",
    "question": "电网公司使用智能电表数据预测短期电力负荷。以下正确的有",
    "options": {
      "A": "时间序列预测方法（如ARIMA、LSTM）适用",
      "B": "天气数据（温度、湿度）是重要的外部特征",
      "C": "异常用电行为可帮助发现设备故障或窃电",
      "D": "只需聚合到天级别，不需要小时或分钟数据"
    },
    "answer": "ABC",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "options": {
      ...
      "C": "可结合内容特征（如电影类型、演员）做混合推荐",
      "D": "推荐系统只需要点击数据，不需要观看时长"
    },
    "answer": "ABC",
    "answer_multi": [
      "A",
  ...
  },
  {
    ...
    "set": 3,
    "type": "case",
    "question": "关于银行使用机器学习评估贷款申请人的信用风险。以下正确的有",
    "options": {
      "A": "特征可包括收入、负债历史、职业等",
      "B": "模型可能存在歧视（如基于种族或性别），需公平性审查",
      "C": "决策树模型一定没有偏见",
      "D": "准确率、召回率是评估模型能力的常用指标"
    },
    "answer": "ABD",
    "answer_multi": [
      "A",
